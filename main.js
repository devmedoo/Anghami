...
function handleDeeplink (e) {
	...
	const o = { deeplink: e, cleanedDeeplink: n, deeplinkParameters: n.split('/') }
...
function filterForAnghamiDeeplink (e) {
	for (var n = 0; n < e.length; n++) { if (e[n].indexOf('anghami://') > -1) return e[n] }
	return !1
}
function unzip (e, n) {
...
ipcMain.on('power-monitor-state', (e, n) => {
	if (n.active) {
		if (powerSaveBlockerId && powerSaveBlocker.isStarted(powerSaveBlockerId)) { return }
